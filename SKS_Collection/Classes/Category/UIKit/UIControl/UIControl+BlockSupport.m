...
- (void)kk_addBlockForControlEvents:(UIControlEvents)controlEvents
...
- (void)kk_setBlockForControlEvents:(UIControlEvents)controlEvents block:(void (^)(id sender))block {
    [self kk_removeAllBlocksForControlEvents:UIControlEventAllEvents];
    [self kk_addBlockForControlEvents:controlEvents block:block];
}
