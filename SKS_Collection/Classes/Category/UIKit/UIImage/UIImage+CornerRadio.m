...
#import "UIImage+CornerRadio.h"

@implementation UIImage (CornerRadio)
...
- (UIImage *)kk_imageByRoundCornerRadius:(CGFloat)radius {
    return [self kk_imageByRoundCornerRadius:radius borderWidth:0 borderColor:nil];
}

- (UIImage *)kk_imageByRoundCornerRadius:(CGFloat)radius
                             borderWidth:(CGFloat)borderWidth
                             borderColor:(UIColor *)borderColor {
    return [self kk_imageByRoundCornerRadius:radius
